    ...
    return (
        <Parallax pages={3} scrolling={true} horizontal={false} ref={refParallax}>
            <ParallaxLayer offset={0} speed={0.5} style={{ backgroundColor: 'red'}}>
                <div>
                    <img src="https://picsum.photos/300/200" width="300px" height="auto" alt="test"/>
            ...
            <ParallaxLayer offset={0.4} speed={-0.2} style={{ backgroundColor: '#ff0'}}>
                <img src={"https://picsum.photos/300/200"} style={{ position: "absolute", left: "20%", top: "0"}} alt="test"/>
            </ParallaxLayer>
            ...
            <ParallaxLayer offset={0.8} speed={0.2} style={{ pointerEvents: 'none' }}>
                <img src={"https://picsum.photos/200/200"} style={{ position: "absolute", right: "20%", bottom: "40%"}} alt="test"/>
            </ParallaxLayer>
            <ParallaxLayer offset={1.3} speed={1} style={{ pointerEvents: 'none' }}>
                <img src={"https://picsum.photos/100/200"} style={{ position: "absolute", right: "10%", top: "30%"}} alt="test"/>
            </ParallaxLayer>
        </Parallax>
    )
};
